"""
Django settings for go_murojaah project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'ji6vur!t+7axv-qww+m)8ryty#7!ek+&iju#otutt40*tvrx2x')
...
ALLOWED_HOSTS = [f'{HEROKU_APP_NAME}.herokuapp.com', '192.168.1.4']
...
WSGI_APPLICATION = 'go_murojaah.wsgi.application'
